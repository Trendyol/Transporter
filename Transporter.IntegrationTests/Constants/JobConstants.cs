...
public static class JobConstants
{
    ...
    {
        public const string SourceBucketName = "test-source-bucket-couchbase-to-mssql";
        public const string AppSettingsFileName = "appsettings_couchbaseToMsSql.json";
    }
    public static class MsSqlToCouchbase
    {
        public const string InterimBucketName = "test-interim-bucket-mssql-to-couchbase";
        public const string InterimBucketIndexName = "test_interim_bucket_mssql_to_couchbase_index";
        public const string TargetBucketName = "test-target-bucket-mssql-to-couchbase";
